...
import com.aducaky.api.client.AducakyClientImpl
...
/**
 * A class that allows building an instance of [AducakyClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class AducakyOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AducakyClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): AducakyClient = builder().fromEnv().build()
    }

    /** A builder for [AducakyOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AducakyClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AducakyClient =
            AducakyClientImpl(
                clientOptions
                    .httpClient(
