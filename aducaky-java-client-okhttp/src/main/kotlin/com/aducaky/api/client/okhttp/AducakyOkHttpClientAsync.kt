...
package com.aducaky.api.client.okhttp

import com.aducaky.api.client.AducakyClientAsync
import com.aducaky.api.client.AducakyClientAsyncImpl
import com.aducaky.api.core.ClientOptions
import com.aducaky.api.core.Timeout
import com.aducaky.api.core.http.Headers
import com.aducaky.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [AducakyClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AducakyOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AducakyClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): AducakyClientAsync = builder().fromEnv().build()
    }

    /** A builder for [AducakyOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.aducaky.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [AducakyClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AducakyClientAsync =
            AducakyClientAsyncImpl(
                clientOptions
                    .httpClient(
