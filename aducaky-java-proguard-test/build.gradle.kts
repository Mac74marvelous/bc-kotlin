...
dependencies {
    testImplementation(project(":aducaky-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../aducaky-java-core/src/main/resources/META-INF/proguard/aducaky-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.aducaky.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../aducaky-java-core/src/main/resources/META-INF/proguard/aducaky-java-core.pro",
