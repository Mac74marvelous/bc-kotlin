...
private constructor(
    ...
    /**
     * @throws AducakyInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws AducakyInvalidDataException if the JSON field has an unexpected type (e.g. if the
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: AducakyInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws AducakyInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw AducakyInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws AducakyInvalidDataException if this class instance's value does not have the
         *   expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow { AducakyInvalidDataException("Value is not a String") }
