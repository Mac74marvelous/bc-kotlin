...
/**
 * A client for interacting with the Aducaky REST API asynchronously. You can also switch to
...
interface AducakyClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AducakyClientAsync
    ...
    /**
     * A view of [AducakyClientAsync] that provides access to raw HTTP responses for each method.
     */
