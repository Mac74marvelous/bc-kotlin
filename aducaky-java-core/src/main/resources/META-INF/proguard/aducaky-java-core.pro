...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.aducaky.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.aducaky.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.aducaky.api.** {
    <init>(...);
