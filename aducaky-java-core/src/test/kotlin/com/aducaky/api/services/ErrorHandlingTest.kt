...
package com.aducaky.api.services
...
import com.aducaky.api.errors.AducakyException
import com.aducaky.api.errors.BadRequestException
import com.aducaky.api.errors.InternalServerException
import com.aducaky.api.errors.NotFoundException
import com.aducaky.api.errors.PermissionDeniedException
import com.aducaky.api.errors.RateLimitException
import com.aducaky.api.errors.UnauthorizedException
import com.aducaky.api.errors.UnexpectedStatusCodeException
import com.aducaky.api.errors.UnprocessableEntityException
...
internal class ErrorHandlingTest {
    ...
    private lateinit var client: AducakyClient
    ...
    fun storeListInventoryInvalidJsonBody() {
        ...
        val e = assertThrows<AducakyException> { storeService.listInventory() }
